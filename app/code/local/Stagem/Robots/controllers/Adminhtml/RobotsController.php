 ...
 */
class Stagem_Robots_Adminhtml_RobotsController extends Mage_Adminhtml_Controller_Action {

	public function indexAction() {
		$this->_initAction();
		$this->_title($this->__('Robots.txt'));
		// see layout
		//$this->_addContent($this->getLayout()->createBlock('stagem_robots/adminhtml_robots'));
	...
	public function editAction() {
		...
		$model = Mage::getModel('stagem_robots/robots')->load($id);

		//$this->loadLayout()->_setActiveMenu('stagem_seo');
		...
		Mage::register('current_stagem_robots', $model);

		$this->_initAction()
			->_addBreadcrumb($id ? $this->__('Edit Robots.txt') : $this->__('New Robots.txt'), $id ? $this->__('Edit Robots.txt') : $this->__('New Robots.txt'))
			//->_addContent($this->getLayout()->createBlock('stagem_robots/adminhtml_robots_edit')->setData('action', $this->getUrl('*/*/save')))
			->renderLayout();
	}
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			try {
				...
				$model = Mage::getModel('stagem_robots/robots');
	...
	public function deleteAction() {
		if ($id = $this->getRequest()->getParam('id')) {
			try {
				Mage::getModel('stagem_robots/robots')->setId($id)->delete();
	...
	protected function _initAction() {
		$this->loadLayout()
			...
			->_setActiveMenu('cms/stagem_robots')
	...
	protected function _isAllowed()	{
		return Mage::getSingleton('admin/session')->isAllowed('cms/stagem_robots');
	}
