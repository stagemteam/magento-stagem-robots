 ...
 */
class Stagem_Robots_Block_Adminhtml_Robots_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {

	public function _construct() {
		parent::_construct();

		$this->setId('stagem_robots_form'); //stagem_robots_robots_form
	...
	protected function _prepareForm() {
		...
		/*$fieldset->addField('category_id', 'select', array(
			...
			'values'   => Mage::getModel('Stagem_Seo_Model_System_Config_Category')->toOptionArray(),
		));*/
