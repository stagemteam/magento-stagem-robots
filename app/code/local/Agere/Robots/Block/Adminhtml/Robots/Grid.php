 ...
 */
class Agere_Robots_Block_Adminhtml_Robots_Grid extends Mage_Adminhtml_Block_Widget_Grid {

	protected function _construct() {
		parent::_construct();

		// set some defaults for our grid
		$this->setId('agere_robots_grid');
	...
	protected function _prepareCollection() {
		/** @var Agere_Robots_Model_Resource_Robots_Collection $collection */
	...
	protected function _prepareColumns() {
		...
		/*$this->addColumn('category_id', array(
			...
			'index'    => 'category_id',
			'type'     => 'options',
			'options'  => Mage::getModel('Agere_Seo_Model_System_Config_Category')->toOptionArray(),
			'renderer' => 'Agere_Seo_Block_Widget_Grid_Column_Renderer_Category',
		));*/
